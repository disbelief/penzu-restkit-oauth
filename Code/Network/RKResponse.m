...
- (NSString*)contentType {
    NSString *fullContentType = [[self allHeaderFields] objectForKey:@"Content-Type"];
    if(fullContentType == nil)
    {
        return fullContentType;
    }
    NSRange semiColon = [fullContentType rangeOfString:@";"];
    if(semiColon.location == NSNotFound)
    {
        return fullContentType;
    }
    return [fullContentType substringWithRange:NSMakeRange(0, semiColon.location)];
