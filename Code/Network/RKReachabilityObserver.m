...
- (RKReachabilityNetworkStatus)networkStatus {
	...
	if (!self.reachabilityEstablished) {
        ...
        //NSLog(@"RKReachabilityIndeterminate");
	...
	if (SCNetworkReachabilityGetFlags(_reachabilityRef, &flags)) {
		...
		if ((flags & kSCNetworkReachabilityFlagsReachable) == 0) {
            //NSLog(@"kSCNetworkReachabilityFlagsReachable == 0");
		...
		if ((flags & kSCNetworkReachabilityFlagsConnectionRequired) == 0) {
            //NSLog(@"kSCNetworkReachabilityFlagsConnectionRequired == 0");
		...
		if ((((flags & kSCNetworkReachabilityFlagsConnectionOnDemand ) != 0) ||
             ...
             //NSLog(@"kSCNetworkReachabilityFlagsConnectionOnDemand != 0 && kSCNetworkReachabilityFlagsConnectionOnTraffic != 0");
			// ... and the connection is on-demand (or on-traffic) if the
			//     calling application is using the CFSocketStream or higher APIs
			
			if ((flags & kSCNetworkReachabilityFlagsInterventionRequired) == 0) {
                //NSLog(@"kSCNetworkReachabilityFlagsInterventionRequired == 0");
		...
		if ((flags & kSCNetworkReachabilityFlagsIsWWAN) == kSCNetworkReachabilityFlagsIsWWAN) {
            //NSLog(@"kSCNetworkReachabilityFlagsIsWWAN == kSCNetworkReachabilityFlagsIsWWAN");
